...
async def startup():
    ...
    if timeline_count == 0:
        sample_timeline = [
            {"id": "inicio", "date": "2025-09-15", "title": "Início do projeto", "description": "A turma 7.E iniciou o projeto sobre o Douro.", "created_at": datetime.now(timezone.utc).isoformat()},
            {"id": "pesquisa", "date": "2025-10-01", "title": "Fase de pesquisa", "description": "Pesquisa sobre a história, cultura e tradições do Douro.", "created_at": datetime.now(timezone.utc).isoformat()},
            {"id": "visita", "date": "2025-11-10", "title": "Visita ao Museu do Douro", "description": "Visita de estudo ao Museu do Douro em Peso da Régua.", "created_at": datetime.now(timezone.utc).isoformat()},
            {"id": "blogue", "date": "2025-12-01", "title": "Lançamento do blogue", "description": "Publicação do blogue com todos os nossos trabalhos.", "created_at": datetime.now(timezone.utc).isoformat()},
        ]
